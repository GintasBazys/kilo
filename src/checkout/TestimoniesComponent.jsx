      ...
      <div className="testimonies">
        <div className="testimonies-block">
          ...
          <div className="comment-block">
            <p>
              I have been using this program for 3 months now and It helped me
              to lose 16lbs, taught me how to breathe properly and now I look
              forward to my workout. Great challenges for different problem
              zones. Definitely recommend to anyone that wants to lose weight
              and feel better without long hour at the gym or exhausting
              workouts.
            </p>
          </div>
        </div>
        <div className="testimonies-block">
          ...
          <div className="comment-block">
            <p>
              ...
              started to enjoy my morning yoga routines where I get my dose of
              cardio, resistance, and stretching in one place. I could barely
              hold a plank at the beginning. Now I’m doing various yoga poses
              that looked impossible at first. My body shape improved a lot and
              I am very motivated by both: results and the feeling of progress.
            </p>
          </div>
        </div>
        <div className="testimonies-block">
